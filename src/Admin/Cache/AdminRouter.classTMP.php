...
/** Inicio  del Bloque de instancia al proceso de /eduardosIndex  */
$datos64 = array('petition'=>"GET", 'request'=>$request, 'name'=>"/eduardosIndex", 'apps'=>"Admin", 'controller'=>"eduardo",'method'=>'runEduardoIndex');
$process64 = $router->setRuta($datos64);
/** Fin del caso de /eduardosIndex */
/** Inicio  del Bloque de instancia al proceso de /eduardosListar  */
$datos65 = array('petition'=>"POST", 'request'=>$request, 'name'=>"/eduardosListar", 'apps'=>"Admin", 'controller'=>"eduardo",'method'=>'runEduardoListar');
$process65 = $router->setRuta($datos65);
/** Fin del caso de /eduardosListar */
/** Inicio  del Bloque de instancia al proceso de /eduardosCreate  */
$datos66 = array('petition'=>"POST", 'request'=>$request, 'name'=>"/eduardosCreate", 'apps'=>"Admin", 'controller'=>"eduardo",'method'=>'runEduardoCreate');
$process66 = $router->setRuta($datos66);
/** Fin del caso de /eduardosCreate */
/** Inicio  del Bloque de instancia al proceso de /eduardosShow  */
$datos67 = array('petition'=>"POST", 'request'=>$request, 'name'=>"/eduardosShow", 'apps'=>"Admin", 'controller'=>"eduardo",'method'=>'runEduardoShow');
$process67 = $router->setRuta($datos67);
/** Fin del caso de /eduardosShow */
/** Inicio  del Bloque de instancia al proceso de /eduardosDelete  */
$datos68 = array('petition'=>"POST", 'request'=>$request, 'name'=>"/eduardosDelete", 'apps'=>"Admin", 'controller'=>"eduardo",'method'=>'runEduardoDelete');
$process68 = $router->setRuta($datos68);
/** Fin del caso de /eduardosDelete */
/** Inicio  del Bloque de instancia al proceso de /eduardosUpdate  */
$datos69 = array('petition'=>"POST", 'request'=>$request, 'name'=>"/eduardosUpdate", 'apps'=>"Admin", 'controller'=>"eduardo",'method'=>'runEduardoUpdate');
$process69 = $router->setRuta($datos69);
/** Fin del caso de /eduardosUpdate */
