...
class ConvenioModel extends Base
{
   use Security;
   public function __construct()
   {
       ...
       $this->campos = array('codigo','nombre');
    ...
    /**
    * Extraer todos los registros de Convenio
    * @return array $tablas
    */ 
   public function getConvenioListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getConvenioListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Convenio
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setConvenioCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Convenio
    * @param: String $id
    * @return array $tablas
    */ 
   public function getConvenioShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remConvenioDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setConvenioUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
