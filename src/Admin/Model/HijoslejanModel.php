...
class HijoslejanModel extends Base
{
   use Security;
   public function __construct()
   {
       $this->tabla = 'hijoslejan';
       $this->campoid = array('id');
       $this->campos = array('lejan_id','nombres','apellidos');
    ...
    /**
    * Extraer todos los registros de Hijoslejan
    * @return array $tablas
    */ 
   public function getHijoslejanListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getHijoslejanListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Hijoslejan
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setHijoslejanCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Hijoslejan
    * @param: String $id
    * @return array $tablas
    */ 
   public function getHijoslejanShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remHijoslejanDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setHijoslejanUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
