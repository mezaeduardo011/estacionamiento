...
class LegajoModel extends Base
{
   use Security;
   public function __construct()
   {
       ...
       $this->campos = array('legajo_numero','documento_numero','nombres','apellidos','sueldo_bruto','convenio_id','fecha_ingreso');
    ...
    /**
    * Extraer todos los registros de Legajo
    * @return array $tablas
    */ 
   public function getLegajoListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getLegajoListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Legajo
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setLegajoCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Legajo
    * @param: String $id
    * @return array $tablas
    */ 
   public function getLegajoShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remLegajoDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setLegajoUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
