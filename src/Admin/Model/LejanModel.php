...
class LejanModel extends Base
{
   ...
   public function __construct()
   {
       ...
       $this->campos = array('convenios_id','nombres','apellidos');
    ...
    /**
    * Extraer todos los registros de Lejan
    * @return array $tablas
    */ 
   public function getLejanListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getLejanListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Lejan
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setLejanCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Lejan
    * @param: String $id
    * @return array $tablas
    */ 
   public function getLejanShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remLejanDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setLejanUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
