...
class LicenciaModel extends Base
{
   use Security;
   public function __construct()
   {
    ...
    /**
    * Extraer todos los registros de Licencia
    * @return array $tablas
    */ 
   public function getLicenciaListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getLicenciaListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Licencia
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setLicenciaCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Licencia
    * @param: String $id
    * @return array $tablas
    */ 
   public function getLicenciaShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remLicenciaDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setLicenciaUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
