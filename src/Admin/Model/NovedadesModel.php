...
class NovedadesModel extends Base
{
   use Security;
   public function __construct()
   {
       ...
       $this->campos = array('licencia_id','fecha_inicio','fecha_fin','dias_a_liquidar','legajo_id');
    ...
    /**
    * Extraer todos los registros de Novedades
    * @return array $tablas
    */ 
   public function getNovedadesListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getNovedadesListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Novedades
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setNovedadesCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Novedades
    * @param: String $id
    * @return array $tablas
    */ 
   public function getNovedadesShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remNovedadesDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setNovedadesUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
