...
class ParentescoModel extends Base
{
   use Security;
   public function __construct()
   {
    ...
    /**
    * Extraer todos los registros de Parentesco
    * @return array $tablas
    */ 
   public function getParentescoListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getParentescoListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Parentesco
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setParentescoCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Parentesco
    * @param: String $id
    * @return array $tablas
    */ 
   public function getParentescoShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remParentescoDelete($datos)
   {
