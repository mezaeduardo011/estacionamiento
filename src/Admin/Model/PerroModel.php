...
class PerroModel extends Base
{
   ...
   public function __construct()
   {
       ...
       $this->campos = array('raza','cant','nombre');
    ...
    /**
    * Extraer todos los registros de Perro
    * @return array $tablas
    */ 
   public function getPerroListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getPerroListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Perro
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setPerroCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Perro
    * @param: String $id
    * @return array $tablas
    */ 
   public function getPerroShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remPerroDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setPerroUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
