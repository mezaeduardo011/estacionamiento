...
class ProcesadorModel extends Base
{
   use Security;
   public function __construct()
   {
       $this->tabla = 'procesador';
       $this->campoid = array('id');
       $this->campos = array('modelos','parte','fabricado');
    ...
    /**
    * Extraer todos los registros de Procesador
    * @return array $tablas
    */ 
   public function getProcesadorListarCombo($request,$result)
   {
    ...
    * @return array $tablas
    */ 
   public function getProcesadorListar($request,$result)
   {
    ...
    /**
    * Crear registros nuevos de Procesador
    * @param: Array $datos
    * @return array $tablas
    */ 
   public function setProcesadorCreate($datos)
   {
    ...
    /**
    * Extraer un registros de Procesador
    * @param: String $id
    * @return array $tablas
    */ 
   public function getProcesadorShow($data)
   {
    ...
    * @return array $tablas
    */ 
   public function remProcesadorDelete($datos)
   {
    ...
    * @return array $tablas
    */ 
   public function setProcesadorUpdate($datos)
   {
     $this->fijarValores($datos);
     $val = $this->guardar();
