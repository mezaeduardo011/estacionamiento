...
<?php $this->push('addJs') ?>
    <script type="text/javascript" src="<?php echo \JPH\Core\Store\Cache::get('srcJs')?>module/configCampos.js"></script>
    <script type="text/javascript" src="<?php echo \JPH\Core\Store\Cache::get('srcJs')?>module/relations.js"></script>
<?php $this->end() ?>