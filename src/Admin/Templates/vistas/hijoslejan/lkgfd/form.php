...
<h3 class="box-title">Formulario de lkgfd</h3>
</div>
<!-- /.box-header -->
<!-- form start -->
<form role="form" method="post" class="Lkgfd" id="sendLkgfdProcesar" enctype="multipart/form-data">
   <div class="box-body">
<input type="hidden" id="id" name="id">
<div class="form-group">
    <label for="lejan_id">lejan_id</label>
    <input type="text" name="lejan_id" class="form-control contar int requerido" id="lejan_id" placeholder="Por favor ingresar el/los lejan_id"  maxlength="10" data-item="10">
