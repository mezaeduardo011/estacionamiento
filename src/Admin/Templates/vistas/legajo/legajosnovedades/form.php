...
<h3 class="box-title">Formulario de Legajos (Novedades)</h3>
</div>
<!-- /.box-header -->
<!-- form start -->
<form role="form" method="post" class="Legajosnovedades" id="sendLegajosnovedadesProcesar" enctype="multipart/form-data">
   <div class="box-body">
<input type="hidden" id="id" name="id">
<div class="form-group">
    <label for="Numero Legajo">Numero Legajo</label>
