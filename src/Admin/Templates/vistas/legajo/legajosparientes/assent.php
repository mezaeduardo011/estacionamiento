    ...
    var Config = {};
    Config.colums = [
        { 'id':'legajo_numero', 'type':'ro', 'align':'left', 'sort':'server', 'value':'Número Legajo', 'widths':'*' },
        { 'id':'documento_numero', 'type':'ro', 'align':'left', 'sort':'server', 'value':'Número Documento', 'widths':'*' },
...
?>
    ...
    Legajosparientes.loadListaMenu();
