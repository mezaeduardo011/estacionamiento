    ...
    Config.colums = [
        ...
        { 'id':'apelidos', 'type':'ro', 'align':'left', 'sort':'server', 'value':'apellidos', 'widths':'*' },
        { 'id':'legajo', 'type':'ro', 'align':'left', 'sort':'server', 'value':'legajo', 'widths':'*' },
        { 'id':'sueldo', 'type':'ro', 'align':'left', 'sort':'server', 'value':'sueldo', 'widths':'*' },
    ];
