<?php
$breadcrumb=(object)array('actual'=>'Abmlegajos','titulo'=>'Vista de integrada de gestion de Abmlegajos','ruta'=>'Abmlegajos')?>
<?php $this->layout('base',['usuario'=>$usuario,'breadcrumb'=>$breadcrumb])?>
<?php $this->push('addCss')?>
<?php $this->end()?>
<?php $this->push('title') ?>
 Gestionar de la vista Abmlegajos
<?php $this->end()?>
<div class="row">
    <!-- left column -->
    <div class="col-md-7">
        <!-- general form elements -->
        <?php $this->insert('view::vistas/legajos/abmlegajos/listado') ?>
    </div>
        <div class="col-md-5">
        <?php $this->insert('view::vistas/legajos/abmlegajos/form') ?>
    </div>
</div>
<?php $this->push('addJs') ?>
<script>
    ...
    var Config = {};
    <?php $this->insert('view::vistas/legajos/abmlegajos/assent') ?>
    Core.Vista.Util = {}
    Core.Vista.Util = {
