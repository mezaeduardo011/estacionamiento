...
<h3 class="box-title">Formulario de legajo</h3>
</div>
<!-- /.box-header -->
<!-- form start -->
<form role="form" method="post" id="sendLegajoProcesar" enctype="multipart/form-data">
   <div class="box-body">
...
<input type="text" name="dni" class="form-control texto requerido " id="dni" placeholder="Por favor ingresar el/los dni">
</div>
  </div>
  <!-- /.box-body -->
