...
<h3 class="box-title">Formulario de Lista de Parentescos</h3>
</div>
<!-- /.box-header -->
<!-- form start -->
<form role="form" method="post" class="Listadeparentescos" id="sendListadeparentescosProcesar" enctype="multipart/form-data">
   <div class="box-body">
