...
<div class="form-group">
    ...
    <input type="text" name="nombre" class="form-control contar correo requerido" id="nombre" placeholder="Por favor ingresar el/los nombre" value="pablo" maxlength="50" data-item="50">
