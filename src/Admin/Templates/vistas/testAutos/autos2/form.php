...
<input type="text" name="marca" class="form-control requerido " id="marca" placeholder="Enter marca">
</div>
<div class="form-group">
<label for="modelo">modelo</label>
<input type="text" name="modelo" class="form-control requerido " id="modelo" placeholder="Enter modelo">
</div>
<div class="form-group">
