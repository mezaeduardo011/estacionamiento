...
<h3 class="box-title">Formulario de estatus</h3>
</div>
<!-- /.box-header -->
<!-- form start -->
<form role="form" method="post" id="sendEstatusProcesar" enctype="multipart/form-data">
   <div class="box-body">
...
<input type="text" name="color" class="form-control contar color requerido" id="color" placeholder="Por favor ingresar el/los color" value="#000011" maxlength="7" data-item="7">
</div>
  </div>
  <!-- /.box-body -->
