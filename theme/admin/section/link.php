<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet" href="<?=JPH\Core\Store\Cache::get('srcCss')?>bower_components/bootstrap/dist/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet" href="<?=JPH\Core\Store\Cache::get('srcCss')?>bower_components/font-awesome/css/font-awesome.min.css">
<!-- Ionicons -->
...
<!-- Morris chart -->
<link rel="stylesheet" href="<?=JPH\Core\Store\Cache::get('srcCss')?>bower_components/morris.js/morris.css">
<!-- jvectormap -->
<link rel="stylesheet" href="<?=JPH\Core\Store\Cache::get('srcCss')?>bower_components/jvectormap/jquery-jvectormap.css">
<!-- Date Picker -->
<link rel="stylesheet" href="<?=JPH\Core\Store\Cache::get('srcCss')?>bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
<!-- Daterange picker -->
<link rel="stylesheet" href="<?=JPH\Core\Store\Cache::get('srcCss')?>bower_components/bootstrap-daterangepicker/daterangepicker.css">
