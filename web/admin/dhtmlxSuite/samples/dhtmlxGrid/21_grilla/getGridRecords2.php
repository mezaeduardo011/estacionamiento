<?php
        ...
        $config[] = array('id' =>"nombres", 'width'=>100, 'type' =>"ed" ,'align' =>"center" ,'sort' =>"str" ,'value' =>"Nombres"  );
        $config[] = array('id' =>"apellidos", 'width'=>100, 'type' =>"ed" ,'align' =>"center" ,'sort' =>"str" ,'value' =>"Apellidos"  );
        $config[] = array('id' =>"idioma", 'width'=>100, 'type' =>"ed" ,'align' =>"center" ,'sort' =>"str" ,'value' =>"Idioma"  );
        $config[] = array('id' =>"correo", 'width'=>150, 'type' =>"ed" ,'align' =>"center" ,'sort' =>"str" ,'value' =>"Correo"  );
        $config[] = array('id' =>"perfil", 'width'=>110, 'type' =>"ed" ,'align' =>"center" ,'sort' =>"str" ,'value' =>"Perfil"  );
        $config[] = array('id' =>"roles", 'width'=>320, 'type' =>"ed" ,'align' =>"center" ,'sort' =>"str" ,'value' =>"Roles"  );
