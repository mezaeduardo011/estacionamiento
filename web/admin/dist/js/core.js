...
var Core = {
    ...
    valComunes: function () {//
        ...
        $('input.requerido').parent('div').children('label').append('<div></div>')
        $('input.requerido').parent('div').children('label').children('div').html('<div style="position: absolute; float: left; font-size: 20px; z-index: 100; color:white; background: red; height: 18px;width: 10px;margin-left: -3px; padding-left: 2px;" title="Campo Requerido">*</div>');
