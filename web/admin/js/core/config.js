...
Config = {
    ...
    loadTableConexiones: function () {
        ...
        $.ajax({
            url: '/getConfiguracionConexiones',
            type: "POST",
            headers: {
...
document.write("<script type='text/javascript' src='admin/js/core/configBox2.js'></script>");
document.write("<script type='text/javascript' src='admin/js/core/configBox3.js'></script>");
document.write("<script type='text/javascript' src='admin/js/core/gestionTablas.js'></script>");
document.write("<script type='text/javascript' src='admin/js/core/configMenu.js'></script>");
document.write("<script type='text/javascript' src='admin/js/core/configMascara.js'></script>");
document.write("<script type='text/javascript' src='admin/js/core/configTipoDatos.js'></script>");
