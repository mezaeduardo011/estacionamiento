...
Config.GestionMenu = {
    ...
    showOptionModel: function(item) {
        ...
        Config.html = '';
         ...
         $.ajax({
             url: '/sendProcesarSubMenu',
             type: "POST",
             headers: {
                 'X-Auth-Token' : $('#csrf_token').val()
             },
             data: {'apps':app,'entidad':entidad,'vista':vista},
             dataType: 'JSON',
             success : function(dataJson) {
        ...
        guardar.click(function (event) {
            ...
            if(Config.currentRequest){
             ...
             Config.currentRequest = $.ajax({
                    ...
                    data: {'hoMenuId':hoMenuId,'apps':apps,'entidad':entidad,'baseUrl':baseUrl,'nombreUrl':nombreUrl,'iconoUrl':iconoUrl,'targetUrl':targetUrl},
                    dataType: 'JSON',
                    success : function(dataJson) {
                        if (dataJson.error == 0) {
