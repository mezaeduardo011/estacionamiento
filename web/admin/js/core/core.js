...
<!-- Notificaciones -->
document.write("<"+"script type='text/javascript' src='/admin/js/core/notificaciones.js'><"+"/script>");
document.write("<"+"script type='text/javascript' src='/admin/js/core/menu.js'><"+"/script>");
document.write("<"+"script type='text/javascript' src='/admin/js/core/jquery.hotkeys.js'><"+"/script>");
document.write("<"+"script type='text/javascript' src='/admin/js/core/autologout.js'><"+"/script>");
document.write("<"+"script type='text/javascript' src='/admin/js/core/teclado.js'><"+"/script>");
document.write("<"+"script type='text/javascript' src='/admin/js/core/vistaGrid.js'><"+"/script>")
document.write("<"+"script type='text/javascript' src='/admin/js/core/vistaRelacion.js'><"+"/script>")
document.write("<"+"script type='text/javascript' src='/admin/js/core/vistaAuditoria.js'><"+"/script>")
document.write("<"+"script type='text/javascript' src='/admin/js/core/vistaMascara.js'><"+"/script>")
